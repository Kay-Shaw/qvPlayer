/****************************************************************************
** Meta object code from reading C++ file 'MyFFmpeg.h'
**
...
#error "The header file 'MyFFmpeg.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 23, 3), // "sec"
QT_MOC_LITERAL(4, 27, 15) // "playCurrentTime"

    },
    "VlcPlayer\0playAllTime\0\0sec\0playCurrentTime"
};
...
void VlcPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->playAllTime((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->playCurrentTime((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VlcPlayer::*)(int );
...
// SIGNAL 0
void VlcPlayer::playAllTime(int _t1)
{
...
// SIGNAL 1
void VlcPlayer::playCurrentTime(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
